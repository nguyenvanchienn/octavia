      ...
      <div class="accordion" id="accordionMain">
        ...
        <div class="accordion-item mb-3 px-4 py-3">
            <form action="{{ route('orders.store') }}" method="post">
                ...
                <!-- Other fields like payment method, bank, etc. -->
        ...
        <div class="accordion-item mb-3 ">
          <h2 class="h5 px-4 py-3 accordion-header d-flex justify-content-between align-items-center">
            ...
            <span>
              <img src="{{ ('/'.'storage/icons/qrcode.jpg') }}" height="50px" alt="logo online banking">
            </span>
          </h2>
          <div id="collapseCC" class="accordion-collapse collapse {{ old('payment_method')==1 ? 'show' : '' }}"
            ...
            <div class="accordion-body">
                ...
                <div id="mbbank" class="form-check w-100 collapsed">
                  <span><img src="{{ ('/'.'storage/icons/qrcode.jpg') }}" alt="MB logo" width="40px"></span>
                  ...
                  <div id="section_mbbank" class="accordion-collapse collapse collapse-pilih-bank" data-bs-parent="#collapseCC">
                    ...
                    <div class="d-flex justify-content-between mt-1">
                      ...
                      <small class="salin-rek">Nguyễn Văn Chiến</small>
                    </div>
                    <div class="divider"></div>
        ...
        <div class="p-3 bg-light bg-opacity-10">
          ...
          <div class="form-group small mb-3">
            Nếu xảy ra lỗi vui lòng liên hệ: <a
              class="link-danger"
              href="https://www.facebook.com/nguyen.chien.259774"
              target="_blank" style="text-decoration: none;">@CHIEN</a>
          </div>
          <button type="submit" class="btn btn-primary w-100 mt-2">Submit</button>
        </div>
      </div>
